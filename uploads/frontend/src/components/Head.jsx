      ...
      <nav>
        <div className="max-w-[1320px] xl:mx-auto flex justify-between items-center h-16 px-4 md:px-0">
          ...
          <div className="hidden md:flex space-x-4">
            <a className="text-[#333333] hover:text-gray-500" href="/">Home</a>
            <a className="text-[#333333] hover:text-gray-500" href="/schedule">Schedule</a>
            <a className="text-[#333333] hover:text-gray-500" href="/news">Cricket News</a>
            <a className="text-[#333333] hover:text-gray-500" href="/series">Series</a>
            <a className="text-[#333333] hover:text-gray-500" href="/ranking">Ranking</a>
            <a className="text-[#333333] hover:text-gray-500" href="/table">Points Table</a>
            <a className="text-[#333333] hover:text-gray-500" href="/teams">Teams</a>
            <a className="text-[#333333] hover:text-gray-500" href="/wtc">WTC</a>
            <a className="text-[#333333] hover:text-gray-500 flex items-center gap-1" href="/">
              More
              <span>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <Link to="/admincms">
              <button className="bg-[#000000] rounded-md p-2 text-white font-semibold px-4 hover:text-gray-300">
                Login
              </button>
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden bg-[#F5F5F5]">
            <a className="block py-2 px-4 text-[#333333] hover:bg-gray-200" href="/">Home</a>
            ...
            <div className="py-2 px-4 flex-col">
              <Link to="/admincms">
                <button className="w-full bg-[#2196F3] rounded-md p-2 text-white font-semibold hover:text-gray-300">
                  Login
                </button>
              </Link>
              <Layout />
